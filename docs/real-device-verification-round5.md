...
**Cache path**: `/home/user/.meshdesk/peers.cache` (configured via `peer_cache_path` in config)
...
```
2026/08/01 04:02:13 [p2p] loaded peer cache: 1 peers from /home/user/.meshdesk/peers.cache
```
