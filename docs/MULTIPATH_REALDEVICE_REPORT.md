...
|------|--------|----|-----|----------|
| txcloud | **ONLINE** | 115.29.235.24 | root@115.29.235.24 (aliyun_key) | Running (PID 719062) |
...
- **Resolution needed**: Open aliyun security group for UDP 7946 from txcloud IP (115.29.235.24)
...
# Deploy (to txcloud)
scp meshdesk root@115.29.235.24:/tmp/meshdesk-test
ssh root@115.29.235.24 "cp /tmp/meshdesk-test /etc/meshdesk/meshdesk && ..."
