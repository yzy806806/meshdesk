...
```
共享节点(3个): N1(fn.example.com), 阿里云(固定IP), DS716(example.com)
...
| **IPv6** | `[240e:360:...]:51820` | IPv6 DDNS节点（如N1 fn.example.com → AAAA） |
...
- N1: `fn.example.com:51820`（域名→IPv6 DDNS，路由器放行端口）
