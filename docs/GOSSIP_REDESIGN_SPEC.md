...
type NodeMeta struct {
    ...
    // pairs (not mesh IPs). Example: ["115.29.235.24:443", "192.168.1.5:443"].
...
**v2 bootstrap:** `seeds: [115.29.235.24:7946]` — real IP:port of seed node
...
type P2pConfig struct {
    ...
    // Example: ["115.29.235.24:7946", "[2001:db8::1]:7946"]
