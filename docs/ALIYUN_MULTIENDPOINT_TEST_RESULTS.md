...
`115.29.235.24:52888` (public IPv4) as the test plan expected. This is a
...
2026/07/30 15:49:10 [p2p] endpoint learning: announced 2 local endpoint(s):
  [[240d:c000:f05f:7900:3870:f7d0:78d4:0]:52888 10.144.144.20:52888] (merged 0 existing)
```

**Analysis:** txcloud's config has:
```yaml
advertise_endpoints:
    - "[240d:c000:f05f:7900:3870:f7d0:78d4:0]:52888"  # Public IPv6
...
IPv4) instead of `115.29.235.24:52888` (public IPv4). For intra-mesh gossip this
