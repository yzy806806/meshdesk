...
func (e *Engine) exchangePunchParams(ctx context.Context, peerKey, fallbackEP string) (string, uint32, error) {
	...
	// aliyun's endpoint as "115.29.235.24:528" and aliyun parsed
	// "[n1.fxxkccp.top]:52888Ι" from a 1-byte-overread — the ep was
...
func (e *Engine) HandleCoordinatorStream(conn net.Conn) {
	...
	// the endpoint: N1 parsed aliyun's "115.29.235.24:52888" as
	// "115.29.235.24:528", and aliyun got "[n1.fxxkccp.top]:52888Ι"
