...
| N1 (node1.example.com) | arm64 | shared | /home/user/.meshdesk/identity.pem | 0000000000000000... | true (52888) | **true** (added) | 0000000000000000 |
...
1. **N1**: `proxy.relay.enabled: true` was MISSING — added. identity_file pointed to
   ...
   key at `/home/user/.meshdesk/identity.pem`; fingerprint updated to 0000000000000000...
2. **txcloud**: `advertise_endpoints` changed from `203.0.113.40:52888` (stale
   shared-node port) → `203.0.113.40:7946` (normal-node mux port).
